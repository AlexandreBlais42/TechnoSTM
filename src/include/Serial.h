...
/** @brief Classe qui permet de communiquer sériellement entre autre pour communiquer avec le DAC 16bits AnalogDevices
 */
class Serial{
public:
   ...
   *  @param devicePath Le chemin du fichier qui permet de communiquer sur le port sériel
